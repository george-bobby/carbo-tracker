...
export default function Page() {
  ...
  <div className="min-h-screen bg-[#e8e6d7] py-6 flex flex-col gap-6 px-4 lg:px-16 md:px-10 sm:px-8">
    ...
    <section className="bg-[#fdd7b0] p-6 rounded-lg shadow-md md:w-3/4 sm:w-3/5 w-full mx-auto mt-4">
    ...
    {/* About Us Section */}
    <section className="rounded-xl w-full h-72 bg-[#b5bf96] md:p-10 sm:p-8 p-6 flex flex-col">
    ...
    {/* FAQ Section */}
    <section className="bg-[#fdd7b0] py-8 px-4 md:px-12 rounded-xl shadow-lg">
      <h3 className="text-3xl text-center font-bold mb-8">Frequently Asked Questions</h3>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {[
          ...
          <div key={index} className="p-6 bg-white rounded-lg shadow-md hover:shadow-xl transition duration-300 ease-in-out">
            <h4 className="text-xl font-semibold text-gray-800 mb-4">{item.question}</h4>
    ...
    <section className="bg-[#e0dfce] py-8 px-4 md:px-12 rounded-xl shadow-lg mt-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
