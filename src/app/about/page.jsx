				...
				<div className='container mx-auto px-4'>
					<div className='text-center mb-10'>
						...
						<p className='text-gray-300 text-lg max-w-xl mx-auto mt-4 leading-relaxed font-light'>
							Have questions about your carbon footprint? We're here to help you
							make a difference.
						</p>
					</div>
					...
					<div className='max-w-4xl mx-auto'>
						...
						<div className='mt-10 grid grid-cols-1 md:grid-cols-3 gap-8'>
							<div className='bg-slate-800/50 backdrop-blur-sm border border-slate-700 p-8 rounded-xl transition-all duration-300 hover:border-emerald-500/50 hover:bg-slate-800/80'>
								...
								<p className='text-gray-400 text-sm leading-relaxed'>
									...
									<br />
									suhas.ls@mzoo.christuniversity.in
								</p>
							</div>
							...
							<div className='bg-slate-800/50 backdrop-blur-sm border border-slate-700 p-8 rounded-xl transition-all duration-300 hover:border-emerald-500/50 hover:bg-slate-800/80'>
								...
								<p className='text-gray-400 text-sm leading-relaxed'>
									Suhas LS: +91 82170 29775
									<br />
									Sahil Gupta: +91 78609 59337
								</p>
							</div>
							...
							<div className='bg-slate-800/50 backdrop-blur-sm border border-slate-700 p-8 rounded-xl transition-all duration-300 hover:border-emerald-500/50 hover:bg-slate-800/80'>
								...
								<p className='text-gray-400 text-sm leading-relaxed'>
									Cabin 20, Block 3, CHRIST (Deemed to be University), Bangalore
									Central Campus
								</p>
							</div>
						</div>
